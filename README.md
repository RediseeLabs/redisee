...
- After the webpage has loaded, click on either the "+" or "connect" button and fill in the name of your Redis instance, port, and host. You will notice your Redis instance added on the sidebar as soon as the form has been submitted.
  ...
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYzg5OTFmMjVmOTJmYzFmNzYyZDM0YzE4ZmUxMDkxZmIwMjRjMDliNyZjdD1n/aFrVoPv9FLq8oVMGla/giphy.gif"  width="900" height="450">
<br>
<br>
<br>
<br>
...
- Click on any of the metrics buttons(Performance, Memory, etc) to monitor the health of your Redis instance.
  ...
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYmNiY2JkNWQ5MTE0MTE3MmQyMzRlOTZhYmM3OTk5YzhlNWUxOWMxNyZjdD1n/NJv0uLAvfRUqy7twJ9/giphy.gif"  width="900" height="450">
<br>
<br>
<br>
<br>
...
- You can create multiple instances and monitor them individually.
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOGQ4NWNlZDY2YTQwMWM5YTgyMDJmYmNhZWM2ODBjMDMyMjY0NzA2MSZjdD1n/l6M8B6BkOhIxI2qfvD/giphy.gif"  width="900" height="450">
...
- If you no longer need to monitor them, you can clear them all at once or individually.
  ...
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYWQ4YjY1ODAzZDkxOWUxYWE5YzllZjkzNWM5OTE1ZGY2N2U1ZmE2MCZjdD1n/ejG2PPKbz0xfbPXfAn/giphy.gif"  width="900" height="450">
...
- Dark mode supported
  ...
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMjFjNTlmZTIyYTI0ZDA0Y2U2ZTAyZmNjODA3Mzg5YTk1MzNiZWJiNiZjdD1n/ziJ2RgyLky2ibO4e65/giphy.gif"  width="900" height="450">
